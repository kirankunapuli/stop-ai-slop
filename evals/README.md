...
Three fixtures, in `evals/fixtures/`, with labels in `evals/expected.json`:
...
|---|---|---|---|---|
| `gpt-6-luna` (default) | 1.00 (10/10) | 0.91 | 0 | Pass |
| `claude-haiku-4-5-20251001` | 1.00 (10/10) | 0.83 | 0 | Pass |

The extra finding from `gpt-6-luna` is a legitimate hedge outside the labeled set, which is why precision stops at 0.91.
...
- **One fixture per domain.** Two sloppy files and one clean file test the core, not the whole catalog.
